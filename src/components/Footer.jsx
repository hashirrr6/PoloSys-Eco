    ...
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white shadow-inner border-t border-gray-200 ">
        <div className="flex justify-between items-center px-6 py-2">
          <a href="/" className="flex flex-col items-center text-xs text-gray-600 hover:text-red-600">
            <FaHome className="text-lg" />
            Home
          </a>
          <a href="/wishlist" className="flex flex-col items-center text-xs text-gray-600 hover:text-red-600">
            <FaHeart className="text-lg" />
            Wishlist
          </a>
          <a href="/cart" className="flex flex-col items-center text-xs text-gray-600 hover:text-red-600">
            <FaShoppingCart className="text-lg" />
            Cart
          </a>
          <a href="/account" className="flex flex-col items-center text-xs text-gray-600 hover:text-red-600">
